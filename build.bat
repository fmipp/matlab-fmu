...
LINK /ERRORREPORT:QUEUE /OUT:"%MODEL_IDENTFIER%.dll" /INCREMENTAL:NO /NOLOGO /LIBPATH:%LIBRARY_PATH% kernel32.lib user32.lib gdi32.lib winspool.lib shell32.lib ole32.lib oleaut32.lib uuid.lib comdlg32.lib advapi32.lib Shlwapi.lib libboost_date_time-vc120-mt-1_58.lib libboost_filesystem-vc120-mt-1_58.lib libboost_system-vc120-mt-1_58.lib libfmipp_fmu_frontend.lib /SUBSYSTEM:CONSOLE /TLBID:1 /DYNAMICBASE /NXCOMPAT /IMPLIB:"%MODEL_IDENTFIER%.lib" /MACHINE:X86 /DLL fmiFunctions.obj /machine:X86 >> %LOG_FILE%
